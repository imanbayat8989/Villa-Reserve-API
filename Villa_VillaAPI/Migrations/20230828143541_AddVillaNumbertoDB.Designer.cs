...
namespace Villa_VillaAPI.Migrations
{
    ...
    [Migration("20230828143541_AddVillaNumbertoDB")]
            ...
            modelBuilder.Entity("Villa_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 8, 28, 19, 5, 41, 554, DateTimeKind.Local).AddTicks(1815),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 8, 28, 19, 5, 41, 554, DateTimeKind.Local).AddTicks(1867),
                            Details = "Some dummy text",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 8, 28, 19, 5, 41, 554, DateTimeKind.Local).AddTicks(1870),
                            Details = "Some dummy text",
