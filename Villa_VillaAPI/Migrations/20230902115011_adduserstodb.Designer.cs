...
namespace Villa_VillaAPI.Migrations
{
    ...
    [Migration("20230902115011_adduserstodb")]
            ...
            modelBuilder.Entity("Villa_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 9, 2, 16, 20, 11, 185, DateTimeKind.Local).AddTicks(4575),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 9, 2, 16, 20, 11, 185, DateTimeKind.Local).AddTicks(4628),
                            Details = "Some dummy text",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 9, 2, 16, 20, 11, 185, DateTimeKind.Local).AddTicks(4631),
                            Details = "Some dummy text",
